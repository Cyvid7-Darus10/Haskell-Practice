...
#include <stdlib.h>
#include <string.h>
#define MAX_CHAR 1010
#define MAX_PAR 5

/*
	Description:
		The program is a representation of how we can use pointers to represent details in a document.
		This is a good way of understanding how naming is important.
*/
