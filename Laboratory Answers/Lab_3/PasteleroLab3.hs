...
{-
Without using loops (use the functions above instead),
write the following functions.

function 1: Given a list of numbers, return the sum of
the squares of the numbers

function 2: three lists, a list of first names, A,
a list of middle names B, and a list of surnames C.
Return a list of whole name strings (list of chars) ([firstname]
[middle initial]. [lastname]) where the length of the string
(including spaces and period) is an even number.
-}
